      ...
      >
        ...
        <div class="card-body">
          ...
          <div class="project-meta">
            <span v-if="d.style" class="style-tag">{{ getStyleLabel(d.style) }}</span>
...
import { getStyleSelectOptions, getStyleLabel } from '~/constants/visual-styles'

const dramas = ref([])
const loading = ref(false)
const showCreate = ref(false)
const form = ref({ title: '', total_episodes: 1, style: '' })
const styleSelectOptions = getStyleSelectOptions()
